...
class SkinMenuOption extends FlxTypedGroup<FlxSprite>
{
	public var Alphabet_Text:Alphabet;
	public var Mod_Icon:SkinIcon;

	public var Skin_Enabled:Bool = false;
	...
	public function new(_Option_Name:String = "-", _Option_Value:String = "Template Mod", _Option_Row:Int = 0)
	{
		...
		Mod_Icon = new SkinIcon(Option_Value);
		Mod_Icon.sprTracker = Alphabet_Text;
		add(Mod_Icon);

		Skin_Enabled = SkinList.skinList.get(Option_Value);
